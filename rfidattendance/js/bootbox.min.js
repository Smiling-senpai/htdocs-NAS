...
!(function (e, t) {
  ...
  function h(e, t, o, a) {
    ...
    a &&
      ...
      (a[0].swapButtonOrder || m.swapButtonOrder) && (t = t.reverse()));
    var n,
      i,
      l,
      s = {
  ...
  function g(e, t, o) {
    e.stopPropagation(),
      e.preventDefault(),
      (p.isFunction(o) && !1 === o.call(t, e)) || t.modal("hide");
  }
  function y(e) {
  ...
  return (
    (d.locales = function (e) {
      return e ? b[e] : b;
    }),
    (d.addLocale = function (e, o) {
      return (
        p.each(["OK", "CANCEL", "CONFIRM"], function (e, t) {
          if (!o[t])
            throw new Error('Please supply a translation for "' + t + '"');
        }),
        (b[e] = { OK: o.OK, CANCEL: o.CANCEL, CONFIRM: o.CONFIRM }),
        d
      );
    }),
    ...
    (d.dialog = function (e) {
      ...
      if (
        ((e = (function (r) {
          ...
          return (
            ...
            v(n, function (e, t, o) {
              if (
                (p.isFunction(t) && (t = n[e] = { callback: t }),
                "object" !== p.type(t))
              )
                throw new Error(
                  'button with key "' + e + '" must be an object'
                );
      ...
      var o = p(f.dialog),
        ...
        i = p(f.footer),
        l = e.buttons,
        s = { onEscape: e.onEscape };
      if (
        (r.find(".bootbox-body").html(e.message),
        0 < w(e.buttons) &&
          (v(l, function (e, t) {
            var o = p(f.button);
      ...
      if (
        ...
        e.title && (r.before(n), o.find(".modal-title").html(e.title)),
        e.closeButton)
      ) {
      ...
      return (
        ...
        o.one("hide.bs.modal", function (e) {
        ...
        "static" !== e.backdrop &&
          o.on("click.dismiss.bs.modal", function (e) {
            o.children(".modal-backdrop").length &&
              (e.currentTarget = o.children(".modal-backdrop").get(0)),
        ...
        p(e.container).append(o),
        o.modal({ backdrop: !!e.backdrop && "static", keyboard: !1, show: !1 }),
        e.show && o.modal("show"),
        o
      );
    }),
    (d.alert = function () {
      var e;
      if (
        (e = h("alert", ["ok"], ["message", "callback"], arguments)).callback &&
    ...
    (d.prompt = function () {
      ...
      switch (((n = p(f.inputs[r.inputType])), r.inputType)) {
        ...
        case "select":
          ...
          r.placeholder && n.attr("placeholder", r.placeholder),
            ...
            v(a, function (e, t) {
              var o = n;
              if (t.value === u || t.text === u)
                throw new Error(
                  'each option needs a "value" property and a "text" property'
                );
              t.group &&
                (i[t.group] ||
                  (i[t.group] = p("<optgroup />").attr("label", t.group)),
                (o = i[t.group]));
              var a = p(f.option);
        ...
        case "radio":
          ...
          v(a, function (e, t) {
            ...
            o.find("input").attr("value", t.value),
              o.find("label").append("\n" + t.text),
              r.value !== u &&
                t.value === r.value &&
      ...
      return (
        (t = d.dialog(r)).off("shown.bs.modal"),
