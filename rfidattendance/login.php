...
<main>
  <h1 class="slideInDown animated" style="font-family: Helvetica, sans-serif;">NFC Attendance system</h1>
  <header>
<div class="topnav" id="myTopnav" style="background-color: Black ; height: 40px ">
	<a style="color:black">a</a>
    ...
    <div class="login-page">
      <div class="form" style="background: black;">
        ...
        <form class="login-form" action="ac_login.php" method="post" enctype="multipart/form-data">
          ...
          <button type="submit" name="login" id="loginp">login</button>
          <p class="message" style="color: black;">Forgot your Password ? <a href="#" style="color: #fff;">Forgot password</a></p>
        </form>
      </div>
    </div>
  </div>
